...
<template>
    <li class="relative boxBg boxShadow !overflow-visible cursor-pointer">
        <Link :href="route('product', {productName: translatedText || ''})" class="h-full flex flex-col">
            <div
            ...
            <div class="pt-4 px-6 pb-8 flex flex-col gap-4 relative">
                <h2 class="blackText text-center text-lg font-bold uppercase">{{data.name.en}}</h2>
                <p class="line-clamp-3">{{data.description.en}}</p>
